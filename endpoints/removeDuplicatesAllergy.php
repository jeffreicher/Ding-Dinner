...
$query = "SELECT count(recipe_id), recipe_id FROM `recipe-allergy` GROUP BY recipe_id ";
...
$query2 = "SELECT ID, recipe_id FROM `recipe-allergy` WHERE ";
...
$DELETEQuery = "DELETE FROM `recipe-allergy` WHERE ";
