    ...
    render() {
        return (
            <header className="groceryHeader z-depth-2" style={this.props.style}>
                {(this.props.back) ? <div className="groceryBack empty" onClick={this.props.onClick}><Link to={this.props.location}><i style={{fontSize: `2rem`}} className="fas fa-arrow-left iconcolor"></i></Link></div> : <div className="empty"></div>}
